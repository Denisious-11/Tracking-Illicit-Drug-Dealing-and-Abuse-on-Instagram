...
public class Police_drug_recy extends RecyclerView.Adapter<Police_drug_recy.MyViewHolder> {
    ...
    public Police_drug_recy(Context applicationContext, JSONArray jsonArray, Activity a) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.drug_post_list, null);
